...
export const Definitions = {
  ...
  tool_next: keybind("none", "Navigate to next tool call"),
  tool_prev: keybind("none", "Navigate to previous tool call"),
  tool_toggle: keybind("none", "Toggle expand/collapse of nearest tool call"),
  tool_expand_all: keybind("none", "Expand all tool calls"),
  tool_collapse_all: keybind("none", "Collapse all tool calls"),
...
export const CommandMap = {
  ...
  tool_next: "session.tool.next",
  tool_prev: "session.tool.prev",
  tool_toggle: "session.tool.toggle",
  tool_expand_all: "session.tool.expand_all",
  tool_collapse_all: "session.tool.collapse_all",
